$(document).ready(function () {
    $('[id^="gallery-carousel-widget-component-"]').each(function () {
        var $this = $(this);
        ...
        $.ajax({
            ...
            data: {
                ...
                block_id: blockId,
                actionType: "galleryCarouselWidget",
            },
            dataType: "json",
            success: function (response) {
                // Inject HTML content into the correct element
                $(`#gallery-carousel-widget-component-${blockId}`).html(response.content);
                ...
                $(`#gallery-carousel-widget-component-${blockId} .owl-carousel`).owlCarousel({
                    loop: true,
                    margin: 10,
                    nav: true,
                    autoplay: false,
