...
const DiscountPhotoVideoReviewReminder = ({ shopRecords, emailTemplateObj, generalAppearances, generalSettingsModel }) => {
    const { t, i18n } = useTranslation();
    const bannerType = "discountPhotoVideoReviewReminder";
    ...
    useEffect(() => {
        ...
        setPlaceHolderLanguageData({
            subject: t('discountPhotoVideoReviewReminderEmail.subject'),
            body: t('discountPhotoVideoReviewReminderEmail.body'),
            buttonText: t('discountPhotoVideoReviewReminderEmail.buttonText'),
        });
    ...
    const handleInputBlur = async (e) => {
        ...
        if (initialData[e.target.name] != e.target.value) {
            const updateData = {
                ...
                language: language,
                actionType: "discountPhotoVideoReviewReminder"
            };
    ...
    const viewSample = (e) => {
        ...
        const sampleEmailData = {
            ...
            body: body ? body : t('discountPhotoVideoReviewReminderEmail.body'),
            buttonText: buttonText ? buttonText : t('discountPhotoVideoReviewReminderEmail.buttonText'),
                                ...
                                <div className="form-group">
                                    ...
                                    <div className='bannerverticalwrap'>
                                        {generalAppearances.enabledEmailBanner == true ? (
                                            ...
                                            <InformationAlert alertType="email_appearance_banner" pageSlug="/app/branding" alertKey="email_discount_photo_video_reminder_customize" alertClose />
...
export default DiscountPhotoVideoReviewReminder;
