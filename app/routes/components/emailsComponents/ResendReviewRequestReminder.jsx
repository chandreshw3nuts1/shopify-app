...
const ResendReviewRequestReminder = ({ shopRecords, emailTemplateObj, generalAppearances, generalSettingsModel }) => {
    const { t, i18n } = useTranslation();
    const bannerType = "resendReviewRequestReminder";
    ...
    useEffect(() => {
        ...
        setPlaceHolderLanguageData({
            subject: t('resendReviewRequestReminderEmail.subject'),
            body: t('resendReviewRequestReminderEmail.body'),
            buttonText: t('resendReviewRequestReminderEmail.buttonText'),
        });
    ...
    const handleInputBlur = async (e) => {
        ...
        if (initialData[e.target.name] != e.target.value) {
            const updateData = {
                ...
                language: language,
                actionType: "resendReviewRequestReminder"
            };
    ...
    const viewSample = (e) => {
        ...
        const sampleEmailData = {
            ...
            body: body ? body : t('resendReviewRequestReminderEmail.body'),
            buttonText: buttonText ? buttonText : t('resendReviewRequestReminderEmail.buttonText'),
                        ...
                        <div className="row">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className='bannerverticalwrap'>
                                        {generalAppearances.enabledEmailBanner == true ? (
                                            ...
                                            <InformationAlert alertType="email_appearance_banner" pageSlug="/app/branding" alertKey="email_resend_review_request_customize" alertClose />
                            ...
                            <div className="col-lg-7">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className='inputnote'>
                                        <div><strong>Notes:</strong></div>
                                        <div>Use [product] as a placeholder for the product name</div>
                                    </div>
                                </div>
                                <div className="form-group">
...
export default ResendReviewRequestReminder;
