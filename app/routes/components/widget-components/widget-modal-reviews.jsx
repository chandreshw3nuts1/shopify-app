...
const WidgetModalRviews = ({ shopRecords, reviewItems, formParams, generalAppearancesModel, CommonRatingComponent, otherProps }) => {
        ...
        <>
            <style>
                {`
                    ...
                    #w3-float-modal-content-widget .modal-content {
                        background-color: ${modalBackgroundOnBlank}  !important;
                    }
				`}
            </style>
            {
                formParams.page == 1 ? <div className="">
                            ...
                            <div className="rightpart">
                                {(formParams.totalReviewItems > 0 && productReviewWidgetCustomizesModel.showRatingsDistribution) && !minimalHeader &&
                                    <div className="stardetaildd">
                                        <div className="stardetailrow flxrow widget_stardetailrow">
                                        ...
                                        <input type="hidden" id="widget_ratting_wise_filter" value={formParams.filterByRatting} />
                                    </div>
                                }
                                {minimalHeader &&
                        ...
                        <div className="right_actions btnwrap flxflexi flxrow justify-content-end">
                            ...
                            {productReviewWidgetCustomizesModel.showSortingOptions &&
                                <div className="dropdown">
                                    ...
                                    {formParams.totalReviewItems > 0 &&
                                        <>	<ul className="dropdown-menu dropdown-menu-end">
                                            <li><a className="dropdown-item widget_sort_by_filter" data-sort="tag_as_feature" href="#">{translations.featured}</a></li>
                                            <li><a className="dropdown-item widget_sort_by_filter" data-sort="newest" href="#">{translations.newest}</a></li>
                                            <li><a className="dropdown-item widget_sort_by_filter" data-sort="highest_ratings" href="#">{translations.highest_rating}</a></li>
                                            <li><a className="dropdown-item widget_sort_by_filter" data-sort="lowest_ratings" href="#">{translations.lowest_rating}</a></li>
                                        </ul>
                                            <input type="hidden" id="widget_sort_by_filter" value={formParams.sortBy} />
                                        </>
                                    }
                                </div>
                            }
                    ...
                    {reviewItems.length > 0 ?
                        <div className={`main_review_block widget_main_review_block  ${gridClassName}-wrap`}>
                    ...
                    {formParams.hasMore == 1 ?
                        <div className="load_more_review">
                            <a href="#" id="widget_load_more_review" className="revbtn custombtn" style={{ border: buttonBorderColor, color: buttonTitleColor, backgroundColor: buttonBackground }}>{languageWiseProductWidgetSettings.showMoreReviewsTitle ? languageWiseProductWidgetSettings.showMoreReviewsTitle : translations.productReviewConstomize.showMoreReviewsTitle}</a>
                            <a href="#" id="widget_w3loadingmorerws" className="revbtn custombtn" style={{ border: buttonBorderColor, color: buttonTitleColor, backgroundColor: buttonBackground, display: "none" }}>{translations.loadingText}</a>
                        </div> :
                        ""
                    }
                </div > :
...
export default WidgetModalRviews;
