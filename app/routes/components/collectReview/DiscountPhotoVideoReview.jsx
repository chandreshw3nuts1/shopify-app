...
export default function DiscountPhotoVideoReview(props) {
    ...
    const changeRadioButtons = async event => {
        try {
            ...
            if (event.target.name == "sameDiscountType" && eventVal == "percentage") {
            ...
            } else if (event.target.name == "differentDiscountPhotoType" && eventVal == "percentage") {
            ...
            } else if (event.target.name == "differentDiscountVideoType" && eventVal == "percentage") {
