...
const DiscountPhotoVideoReviewEmail = ({ emailContents, generalAppearancesObj, shopRecords }) => {
    ...
    if (emailContents.expire_on_date != null && emailContents.expire_on_date != "") {
        expiredHtml = ` <tr>
            <td style="text-align: center; margin-top: 12px;">
            <div style="font-size: 14px; color: #000000; text-align: center;">
                <span>Discount expires: ${emailContents.expire_on_date}</span>
            </div>
            </td>
        </tr>`;
    }
...
export default DiscountPhotoVideoReviewEmail;
